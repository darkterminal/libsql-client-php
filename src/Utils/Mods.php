...
class Mods
{
     ...
     */
    public static function transactionModeToBegin(string $mode): string
    {
        switch ($mode) {
            case "write":
     ...
     */
    public static function expandConfig(array $config, bool $preferHttp): ExpandedConfig
    {
     ...
     */
    public static function parseQuery(string $text): Query
    {
     ...
     */
    public static function percentDecode(string $text): string
    {
        try {
     ...
     */
    public static function encodeBaseUrl(string $scheme, ?Authority $authority, string $path): array|string|int|false|null
    {
        if ($authority === null) {
     ...
     */
    public static function encodePort(?int $port): string
    {
     ...
     */
    public static function encodeUserInfo(?UserInfo $userInfo): string
    {
        if ($userInfo === null) {
            return "";
        }
     ...
     */
    public static function checkColumnType(mixed $column): string
    {
        $type = 'unknown';
